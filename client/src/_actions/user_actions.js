...
import { USER_SERVER, AUTH_SERVER } from '../components/Config.js';

export function registerUser(dataToSubmit){
    const request = axios.post(`${AUTH_SERVER}/register`,dataToSubmit)
...
export function getHistory(data) {
    ...
    const request = axios.get(`${USER_SERVER}/history`, data)
        .then(response => response.data);
